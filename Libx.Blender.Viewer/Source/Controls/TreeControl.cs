...
/*/ Helper classes around a Eto.Forms.TreeGridView.

    TreeStore defines the data to display.
    As the representation of columns and rows is dependent on the data, the TreeStore also manages the creation of column and row controls.
    You must define the GetColumns and CreateItems methods yourself.
/*/
