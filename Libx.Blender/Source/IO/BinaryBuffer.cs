...
namespace Libx.Blender.IO
{
     ...
     public interface IBinaryBuffer
     {
          ...
          //byte[] get (len_t pos, len_t len);
          //byte[] gNE (len_t pos, len_t len);
          //byte[] ZgetZ (len_t pos, len_t len);
          //byte[] getZ (len_t pos, len_t len);
     ...
     public class BinaryBuffer : IBinaryBuffer, IOffsetTable
     {
          ...
          // public virtual byte[] get (len_t pos, len_t len)
          // {
          //      pos += BodyPosition;
          ...
          //      return arr;
          // }
          // public virtual byte[] gNE (len_t pos, len_t len)
          // {
          //      pos += BodyPosition;
          //      var bytes = new byte[len];
          //      for (len_t i = 0; i < len; i++) bytes[i] = Body[pos + i];
          //      return bytes;
          // }
          // public virtual byte[] getZ (len_t pos, len_t len)
          // {
          //      pos += BodyPosition;
          //      var arr = new byte[len];
          //      byte b;
          ...
          //      return arr;
          // }
          // public virtual byte[] ZgetZ (len_t pos, len_t len)
          // {
          //      var p = BodyPosition + pos;
          //      byte b;
          //      len_t i;
