...
namespace Libx.Blender.IO
{
     ...
     public partial class File
     {
          ...
          File (byte[] bin)
          {
               ...
               //Buffer = new BinaryBuffer (bin, Endian, PointerSize == 8, 0, bin.Length);
               ...
               var bin4  = new byte[4];
               var index = 0;
               //var a_builder = new ArrayBuilder <Block> (1000);
               var b_builder = new ArrayBuilder <Block> (1000);
               //var b_matrix = new StaticMatrixBuider <Block> (BlockCodeExtension.IDCount (), 10);
               for(;;)
               {
                    ...
                    //if (block.OldAddress.IsValid)
                    //     a_builder.Add (block);

                    //id_index = code.ToIndex ();
                    //if (id_index > -1)
                    //{
                    //     b_matrix.Add (id_index, block);
                    //}

                    index++;
               }

               // Blocks = b_builder.ToArray ();
               // BlockTable = b_matrix.ToAMatrix ();
               Blocks = new BlockTable (b_builder);

               //Addresses = a_builder.ToArray ();
               //Array.Sort (Addresses, CompareBlockAddress);
               ...
               //var dna1 = Blocks[Blocks.Length - 1];
          ...
          //public Block[] Addresses { get; }
          //public Block[][] BlockTable { get; }
          ...
          // public Block[] GetByCode (BlockCode code)
          // {
          //      return BlockTable[code.ToIndex ()];
          // }
          ...
          //          return null;
          //
          //     var i = ArrayLib.BinarySearch <Block> (
          //          Addresses, 0, Addresses.Length,
          //          b => b.OldAddress.CompareTo (address)
          //     );
          //     return i < 0 ? null : Addresses[i];
          //}
          public Block? GetBlock (adr_t address)
          {
